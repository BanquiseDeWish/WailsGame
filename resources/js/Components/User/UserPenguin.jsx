            ...
            <svg id="penguin">
                <g id="penguin_body" transform={`translate(${viewBoxWidth / 2 - 250},${viewBoxHeight - 700})`}>
                    ...
                    <g id="left_foot">
                        ...
                        <path id="Vector_2" d="M373.766 561.007C427.766 561.007 396.317 585.008 391 615.138C386.5 640.638 342.5 632.638 330 619.138C327.564 616.508 326.967 610.91 324.875 606.888C322 601.359 322 601.359 322 599.138C322 559.508 332.766 561.007 373.766 561.007Z" fill={cosmetics.colors.main_color} />
                    </g>
                    <g id="body">
                        <g id="belly">
                    ...
                    <g id="right_foot">
                        ...
                        <path id="Vector_13" d="M230.5 578.5C284.5 578.5 253.051 602.5 247.734 632.631C243.234 658.131 199.234 650.131 186.734 636.631C184.297 634 183.7 628.403 181.609 624.381C178.734 618.851 178.734 618.851 178.734 616.631C178.734 577 189.5 578.5 230.5 578.5Z" fill={cosmetics.colors.main_color} />
                    </g>
                    <g id="right_arm">
                        <path id="top_right_arm" d="M194.671 205.006C201.047 208.126 200.607 229.144 199.424 240.633C194.671 283.392 163.047 381.931 114.296 403.631C98 410.885 48.6948 361.5 60.0255 342.496C61.6422 339.784 63.2412 337.063 64.8351 334.338C81.9605 305.203 102.315 277.9 124.734 252.631C125.592 251.659 126.451 250.687 127.335 249.686C175.576 196.068 187.547 201.52 194.671 205.006Z" fill={cosmetics.colors.dark_main_color} />
                        <path id="right_arm_2" d="M114.296 403.631C98.7225 410.563 86.3482 422.2 74.3326 433.986C60.3883 447.709 22.5471 503.892 3.73353 495.631C-1.45277 492.892 0.0635834 486.255 0.733531 480.631C6.37224 447.475 22.4131 415.737 36.7335 385.631C37.187 384.678 37.6404 383.724 38.1076 382.741C44.7331 368.914 52.1623 355.654 60.0255 342.496C61.6422 339.784 63.2412 337.063 64.8351 334.338C75.5614 316 151.54 385.631 119 401.442C117.456 402.193 115.888 402.923 114.296 403.631Z" fill={cosmetics.colors.dark_main_color} />
                    </g>
                </g>
            </svg>
        </svg>
